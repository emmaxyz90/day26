...
var play = function(userChoice){
	...
	if (userChoice == 'rock' || userChoice == 'paper' || userChoice == 'scissors'){
		...
		document.getElementById('player').innerHTML = 'You choose' + ' ' + userChoice + '.<br/>Well aren\'t you a smarty pants.';
	}else{
	...
	document.getElementById('opponent').innerHTML = '//Your opponent choose' + ' ' + computerChoice + '.';
	...
	if (loses > 999){
		alert('Your opponent reached the max score of 999.<br/> We are sorry, you have no life.');
	}
};
